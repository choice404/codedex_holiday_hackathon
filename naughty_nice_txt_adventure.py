...
class NaughtyOrNiceGame:
    ...
    def run_game(self):
        ...
        self.process_choice(choice_caroling, "\nYou picked Rudolph's favorite and Rudolph is beaming!",
